        ...
        <>
            <form onSubmit={processForm} class="form">
                <div className="border p-3 mx-5 bg-light mb-3 rounded d-flex align-items-center" >
                    ...
                    <input type="text" name="firstName" id="firstName" onChange={handleFirstName} className="form-control" />
                </div>
                {
                    firstNameError ?
                ...
                <div className="border p-3 mx-5 bg-light mb-3 rounded d-flex align-items-center">
                    ...
                    <input type="text" name="lastName" id="lastName" onChange={handleLastName} className="form-control" />
                </div>
                {
                    lastNameError ?
                ...
                <div className="border p-3 mx-5 bg-light mb-3 rounded d-flex align-items-center">
                    ...
                    <input type="text" name="email" id="email" onChange={handleEmail} className="form-control" />
                </div>
                {
                    emailError ?
                ...
                <div className="border p-3 mx-5 bg-light mb-3 rounded d-flex align-items-center">
                    ...
                    <input type="password" name="password" id="password" onChange={handlePassword} className="form-control" />
                </div>
                {
                    passwordError ?
                ...
                <div className="border p-3 mx-5 bg-light mb-3 rounded d-flex align-items-center">
                    ...
                    <input type="password" name="confPassword" id="confPassword" onChange={handleConfPassword} className="form-control" />
                </div>
                {
                    confPasswordError ?
